                ...
                <section className="services-approach">
                    <div>
                        ...
                        <div className="approach-steps">
                            ...
                            <div className="approach-step">
                                ...
                                <div>
                                    <div className="step-t">Ongoing Partnership</div>
                                    <p className="step-b">We revisit, refine, and evolve the plan as your land responds and grows. This is a
                                        relationship.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="approach-visual">
                        <div className="approach-img">
                            <img src={TreeImg1} alt="WOLFF crew at work" />
                        </div>
                    </div>
                </section>
