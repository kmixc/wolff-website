...
export default function TreeCare() {
    return (
        <div>
            <div id="page-treecare" class="page pt-nav">

                <section class="page-hero">
                    <div class="page-hero-bg"></div>
                    <div class="page-hero-content">
                        <div class="page-hero-eye">Services / Tree Care</div>
                        <h1 class="page-hero-title">Your trees are an<br /><em>investment. We protect it.</em></h1>
                        <div class="page-hero-rule"></div>
                        <p class="page-hero-sub">ISA Certified Arborist care — pruning, health assessment, safe removal, and
                ...
                <div class="strip">
                    <div class="strip-item">
                        <div class="strip-dot"></div>ISA Certified Arborist
                    </div>
                    <div class="strip-item">
                        <div class="strip-dot"></div>Chemical-Free Health Programs
                    </div>
                    <div class="strip-item">
                        <div class="strip-dot"></div>Safe Removal &amp; Stump Grinding
                    </div>
                    <div class="strip-item">
                        <div class="strip-dot"></div>Storm Damage Response
                    </div>
                </div>

                <section class="tree-services">
                    <div class="tree-services-head">
                        <div class="sec-eye">Tree Care Services</div>
                        <h2 class="sec-title">Everything your trees need to <em>thrive and stand safely</em></h2>
                    </div>
                    <div class="tree-grid">
                        <div class="tree-card">
                            <div class="tree-icon">
                            ...
                            <div class="tree-card-title">Structural Pruning</div>
                            <p class="tree-card-body">Crown thinning, deadwood removal, and structural work that improves form, light
                                penetration, and long-term health. Done by hand with the tree's architecture in mind.</p>
                            <span class="tree-card-link">Learn more →</span>
                        </div>
                        <div class="tree-card">
                            <div class="tree-icon">
                                <svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="tree-card-title">Health Assessments</div>
                            <p class="tree-card-body">A thorough evaluation of your tree's structural integrity and vitality — identifying
                        ...
                        <div class="tree-card">
                            ...
                            <div class="tree-card-title">Tree Removal</div>
                            <p class="tree-card-body">Safe, methodical removal of hazardous, dying, or misplaced trees. We use rigging and
                        ...
                        <div class="tree-card">
                            ...
                            <div class="tree-card-title">Stump Grinding</div>
                            <p class="tree-card-body">Complete stump removal below ground level, leaving a clean finish ready for
                        ...
                        <div class="tree-card">
                            ...
                            <div class="tree-card-title">Storm Damage</div>
                            <p class="tree-card-body">Priority response for storm-damaged trees — removing broken limbs, assessing
                        ...
                        <div class="tree-card">
                            ...
                            <div class="tree-card-title">Young Tree Training</div>
                            <p class="tree-card-body">Early structural pruning for newly planted trees that sets them up for decades of
                ...
                <section class="tree-safety">
                    <div class="safety-visual">
                        <div class="safety-img"><span>Photo placeholder —<br />arborist at work</span></div>
                    </div>
                    <div>
                        <div class="sec-eye" >Why It Matters</div>
                        <h2 class="sec-title-light">Trees are long-term<br /><em>assets. Treat them that way.</em></h2>
                        <div class="safety-checklist">
                            <div class="safety-item">
                                <div class="safety-check"></div>
                                <div class="safety-text"><strong>ISA Certified Arborist on every job</strong><span>Not a crew member with a
                                    chainsaw — a trained professional with deep knowledge of tree physiology and safe work practices.</span>
                                </div>
                            </div>
                            <div class="safety-item">
                                <div class="safety-check"></div>
                                <div class="safety-text"><strong>No chemical pest or disease treatments</strong><span>We use integrated,
                                    organic approaches to pest and disease management — no systemic insecticides, no synthetic
                                    fungicides.</span></div>
                            </div>
                            <div class="safety-item">
                                <div class="safety-check"></div>
                                <div class="safety-text"><strong>Full liability and WSIB coverage</strong><span>Every job is fully insured.
                                    You're protected, and so are we — and we can provide certificates of insurance on request.</span></div>
                            </div>
                            <div class="safety-item">
                                <div class="safety-check"></div>
                                <div class="safety-text"><strong>Clean-up included</strong><span>We leave your property cleaner than we
                ...
                <section class="tree-seasonal">
                    <div class="seasonal-head">
                        <div class="sec-eye">Seasonal Care Calendar</div>
                        <h2 class="sec-title">The right care at the <em>right time</em></h2>
                    </div>
                    <div class="seasonal-grid">
                        <div class="season-card spring">
                            <div class="season-name">Spring</div>
                            <div class="season-title">Assessment &amp; Early Care</div>
                        ...
                        <div class="season-card summer">
                            ...
                            <div class="season-title">Monitoring &amp; Clearance</div>
                            <ul class="season-list">
                        ...
                        <div class="season-card fall">
                            ...
                            <div class="season-title">Structural Pruning</div>
                            <ul class="season-list">
                        ...
                        <div class="season-card winter">
                            ...
                            <div class="season-title">Dormant Season Work</div>
                            <ul class="season-list">
