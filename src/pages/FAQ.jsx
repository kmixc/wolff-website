...
export default function FAQ() {
    return (
        <div>
            <div id="page-faq" class="page pt-nav">

                <section class="page-hero" >
                    <div class="page-hero-bg"></div>
                    <div class="page-hero-content" >
                        <div class="page-hero-eye">Questions &amp; Answers</div>
                        <h1 class="page-hero-title">Everything you <em>want to know</em></h1>
                        <p class="page-hero-sub">The honest answers to the questions we hear most — about our approach, our practices,
                ...
                <div class="faq-layout">
                    ...
                    <div class="faq-content">
                        <div class="faq-group">
                            <div class="faq-group-title">Our Approach</div>
                            <div class="faq-item open">
                                <div class="faq-q">What does "regenerative" land care actually mean?</div>
                                <div class="faq-a">Regenerative land care means we're not just maintaining the status quo of your property —
                            ...
                            <div class="faq-item">
                                <div class="faq-q">How is WOLFF different from a conventional landscaping company?</div>
                                <div class="faq-a">The core difference is philosophy. Conventional landscaping often relies on synthetic
                            ...
                            <div class="faq-item">
                                <div class="faq-q">Do you work on small residential properties or only larger acreages?</div>
                                <div class="faq-a">Both. Our regenerative landscaping and permaculture projects often involve larger rural
                        ...
                        <div class="faq-group">
                            <div class="faq-group-title">Organic &amp; Chemical-Free</div>
                            <div class="faq-item">
                                <div class="faq-q">What exactly is "SOUL Certified" and what does it mean for my property?</div>
                                <div class="faq-a">SOUL stands for Stewards of Our Urban Lands. It's an organic land care certification that
                            ...
                            <div class="faq-item">
                                <div class="faq-q">Can you really manage weeds and pests without chemicals?</div>
                                <div class="faq-a">Yes — with the right approach. Healthy soil and well-chosen plants resist most pest and
                            ...
                            <div class="faq-item">
                                <div class="faq-q">What if my property has existing chemical use from a previous provider?</div>
                                <div class="faq-a">This is common, and not a barrier to working with us. We'll assess the current state of
                        ...
                        <div class="faq-group">
                            <div class="faq-group-title">Pricing &amp; Quotes</div>
                            <div class="faq-item">
                                <div class="faq-q">How does pricing work? Do you have packages?</div>
                            ...
                            <div class="faq-item">
                                <div class="faq-q">Is organic land care more expensive than conventional?</div>
                            ...
                            <div class="faq-item">
                                <div class="faq-q">Is the initial consultation free?</div>
                        ...
                        <div class="faq-group">
                            <div class="faq-group-title">Service Area</div>
                            <div class="faq-item">
                                <div class="faq-q">Where do you provide services?</div>
